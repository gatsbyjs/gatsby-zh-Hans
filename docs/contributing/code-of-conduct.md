...
项目维护者有权利和义务删除、编辑、拒绝违背本行为标准的评论（comments）、提交（commits）、代码、wiki 编辑、问题（issues）等贡献；项目维护者可暂时或永久地封禁任何他们认为行为不当、威胁、冒犯、有害的参与者。
...
可以致信[conduct@gatsbyjs.com](mailto:conduct@gatsbyjs.com) ，向项目团队举报滥用、骚扰及不当行为。
